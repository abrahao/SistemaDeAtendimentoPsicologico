                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            ?>
                                <form action="atualizar.php?id_cad_pac=<?php echo ($dados['id_cad_pac']) ?>" method="POST">
                                    <div class="row">
                                        <input required type="hidden" tabindex="1" class="mr-3 form-control" id="id_cad_pac" name="id_cad_pac" placeholder="Nome Completo *" value="<?php echo ($dados['id_cad_pac']) ?>">
