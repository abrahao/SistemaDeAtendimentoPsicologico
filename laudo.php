  ...
  <div class="breadcrumb-holder">
    <div class="container-fluid">
      <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Laudo</li>
      </ul>
    </div>
  </div>
  <section class="forms">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <button type="button" class="btn btn-info">Histórico de Laudos</button>

              <body>
                <h4>Laudo Psicológico</h4>
                <form method="post">
                <textarea id="mytextarea" style="resize: vertical" rows="18">
                   <h4 style="text-align:center;">LAUDO PSICOLOGICO</h4> <br>
