...
<div class="page">
    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                <li class="breadcrumb-item active">Atender Paciente</li>
            </ul>
        </div>
    </div>
    <section class="forms">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="./list_consult_ant.php?id_pac=<?php echo $id_pac ?>&nome_pac=<?php echo $nome_pac ?>" target="blank"><button style="background: #00FF00; border-radius: 3px; padding: 7.5px; cursor: pointer; color: #000000; border: none; font-size: 16px;">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <input readonly type="hidden" tabindex="1" class="mr-3 form-control" id="id_pac" name="id_pac" value="<?= $dados['id_pac'] ?>">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <br>
                                            <div class="form-group">
                                                <textarea required type="text" tabindex="2" rows="15" cols="100" class="mr-3 form-control" id="notaAtend" name="notaAtend" placeholder="Notas de atendimento *"></textarea>
                                            </div>
                                            <br>
                                        </div>
                                        <br>
